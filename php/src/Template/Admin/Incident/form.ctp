      ...
      <div class="modal-body">
        ...
        <form id="add_incident_form" action="<?= $action ?>" method="post">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="incidentTitle" id="incident_title_input" placeholder="Enter incident title" value="<?= h($incidentTitle) ?>">
          </div>
          <!-- Location -->
          <div class="form-group">
              <label>Location</label>
              <input type="text" class="form-control" value="<?= h($address) ?>" name="address" id="incident_location_input" placeholder="Enter the location where the incident happened">
              <div class="details">
          ...
          <div class="form-group">
              ...
              <select class="form-control" name="incidentCategoryID" id="incident_category_id">
                ...
                <option <?php if($incidentCategoryID == $v['id']){echo "selected";} ?> value=<?='"'. $v['id'] . '"'?>><?=h($v['title'])?></option>
                <?php }?>
              </select>
          </div>
